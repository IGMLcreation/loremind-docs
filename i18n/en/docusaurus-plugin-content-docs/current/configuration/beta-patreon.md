...
LoreMind's Patreon supporters get access to a **pre-release** channel:
...
3. In LoreMind, **Settings → License**, you paste the token
...
- LoreMind validates the signature locally (embedded public key) — no network call to verify the license
